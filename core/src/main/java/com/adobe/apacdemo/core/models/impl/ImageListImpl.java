 ...
 */
package com.adobe.apacdemo.core.models.impl;

import com.adobe.apacdemo.core.models.ImageList;
...
public class ImageListImpl implements ImageList {
    ...
    protected static final String RESOURCE_TYPE = "secubank/components/image-list";
    ...
    private class ImageListItemImpl implements ImageList.ListItem {
        private static final String IMAGE_RESOURCE_TYPE = "securbank/components/image";
