...
(function($) {
    ...
    var fileReference;
    var presetTypeSelector = ".cmp-teaser__editor-dynamicmedia-presettype";
    var imagePresetDropDownSelector = ".cmp-teaser__editor-dynamicmedia-imagepreset";
    var smartCropRenditionDropDownSelector = ".cmp-teaser__editor-dynamicmedia-smartcroprendition";
    ...
    $(document).on("dialog-loaded", function(e) {
        ...
        if (dialogContent) {
            ...
            $dynamicMediaGroup = $dialogContent.find(".cmp-teaser__editor-dynamicmedia");
